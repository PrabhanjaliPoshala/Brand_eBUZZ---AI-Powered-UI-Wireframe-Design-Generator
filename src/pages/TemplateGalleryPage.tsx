        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 md:px-10">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-sm font-extrabold tracking-tight text-zinc-900">Template Gallery</h1>
          ...
          {filtered.map((tmpl) => (
            ...
            >
              <div>
                ...
                <div className="mb-3 h-28 rounded-2xl bg-gradient-to-br from-slate-100 via-white to-blue-50 p-3">
